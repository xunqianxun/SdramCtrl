...
`define AXIGETDATA   8'b00000011
`define AXIWEITERF   8'b00000100 
...
`define SCOREPCHGE    8'b00000111 
`define SCOREROWACT   8'b00001111 
`define SCOREMRS      8'b00011111 
`define SCOREREAD     8'b00111111 
`define SCOREWRITE    8'b01111111 
`define OPTFINISH     8'b11111110 
`define SCOREAREF     8'b11111111 
...
//SDRAM write and Read state 
`define SDRAMWRIDLE   8'b00000001 
`define SDRAMMRS      8'b00000011 
`define SDRAMPRECHG   8'b00000111
`define SDRAMROWACT   8'b00001111 
`define SDRAMRABLE    8'b00011111 
`define SDRAMWABLE    8'b00111111
